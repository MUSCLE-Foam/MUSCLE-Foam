...
endTime = "20" # Change if necessary

csv_flux = read_csv("../postProcessing/horizontal/"+endTime+"/horizontal.csv")

x = csv_flux['x'].tolist()

flux0 = csv_flux['totalFlux0'].tolist()
flux1 = csv_flux['totalFlux1'].tolist()
flux2 = csv_flux['totalFlux2'].tolist()
flux3 = csv_flux['totalFlux3'].tolist()
flux4 = csv_flux['totalFlux4'].tolist()
flux5 = csv_flux['totalFlux5'].tolist()
